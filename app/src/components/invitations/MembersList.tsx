        ...
        return (
          ...
          >
            ...
            <div className="flex items-center">
              {member.isAccepted ? (
                <div className="bg-green-100 text-green-700 p-1.5 rounded-full" title="Member has accepted">
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
              ) : (
                <div className="bg-orange-100 text-orange-600 p-1.5 rounded-full" title="Pending acceptance">
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
